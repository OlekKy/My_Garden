...
import com.example.pol_elektroniki.my_garden3.adapter.CustomAdapter;
...
public class BuildingsFragment extends Fragment {
    ...
    int [] icon = {R.drawable.tower, R.drawable.tower,R.drawable.tower};
    String [] opis = {"Pierwszy budynek","Drugi budynek","Trzeci budynek"};
    String [] description = {"Ten budynek robi cos","Ten cos innego","A ten jeszcze cos innego"};
    ...
    private void initDataset() {
        mDataset = new String[opis.length];
