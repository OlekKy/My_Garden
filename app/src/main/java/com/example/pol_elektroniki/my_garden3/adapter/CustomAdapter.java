package com.example.pol_elektroniki.my_garden3.adapter;

/**
 * Created by Aleksander on 22.05.2017.
 */
...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            textView = (TextView) v.findViewById(R.id.opis);
            textView2 = (TextView) v.findViewById(R.id.description);
            icon = (ImageView) v.findViewById(R.id.tower);
        }
    ...
    // END_INCLUDE(recyclerViewSampleViewHolder)asd
